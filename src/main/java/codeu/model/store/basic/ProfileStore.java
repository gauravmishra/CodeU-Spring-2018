...
public class ProfileStore {
    ...
    /**
     * Returns the singleton instance of ProfileStore that should be shared
     * between all servlet classes.
     ...
     */
    public static ProfileStore getTestInstance(PersistentStorageAgent
    ...
    /** Add a new profile to the current set of profiles known to the
     * application.
     * */
